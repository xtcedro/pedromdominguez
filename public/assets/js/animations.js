...
export function runSovereignTimeline() {  
...
export function animateStaggerGrid(selector) {  
  anime({  
    targets: selector,  
    translateY: [50, 0],  
    opacity: [0, 1],  
...
export function animateKeyframes(target) {  
  anime({  
    targets: target,  
    keyframes: [  
      { translateY: -20 },  
...
/* === 6️⃣ Matrix Flicker Trail (Optional Custom) === */  
export function animateMatrixChar(target) {  
  anime({  
    targets: target,  
    opacity: [  
